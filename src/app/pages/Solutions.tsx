...
export function Solutions() {
  ...
  return (
    <div>
      ...
      <section className="py-20" style={{ backgroundColor: 'var(--th-bg-primary)' }}>
        <div className="max-w-[1000px] mx-auto px-8">
          <h2 className="mb-12 text-center" style={{ fontSize: '40px', fontWeight: 600, color: 'var(--th-text-heading)' }}>
            How Ascenda works
          </h2>
      ...
      <section className="py-20" style={{ backgroundColor: 'var(--th-bg-secondary)' }}>
        <div className="max-w-[1100px] mx-auto px-8">
          <h2 className="mb-8" style={{ fontSize: '40px', fontWeight: 600, color: 'var(--th-text-heading)' }}>
            What we automate
          </h2>
